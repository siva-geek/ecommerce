...
-- Dumping data for table ecomm.cart: ~0 rows (approximately)
...
-- Dumping data for table ecomm.details: ~7 rows (approximately)
...
-- Dumping data for table ecomm.products: ~27 rows (approximately)
...
-- Dumping data for table ecomm.sales: ~2 rows (approximately)
...
-- Dumping data for table ecomm.users: ~10 rows (approximately)
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`id`, `email`, `password`, `name`, `phone`, `role`, `user_name`) VALUES
	(1, 'admin@admin.com', '$2y$10$0SHFfoWzz8WZpdu9Qw//E.tWamILbiNCX7bqhy3od0gvK5.kSJ8N2', NULL, NULL, NULL, NULL),
	(9, 'harry@den.com', '$2y$10$Oongyx.Rv0Y/vbHGOxywl.qf18bXFiZOcEaI4ZpRRLzFNGKAhObSC', NULL, NULL, NULL, NULL),
	(12, 'christine@gmail.com', '$2y$10$ozW4c8r313YiBsf7HD7m6egZwpvoE983IHfZsPRxrO1hWXfPRpxHO', NULL, NULL, NULL, NULL),
	(13, 'rifogidav@mailinator.com', '$2y$10$YsbN6AMSPnBfR8WTozlMEu9OHZvlmqnmDfjNsQ/Tn/Oet92GslayW', NULL, NULL, NULL, NULL),
	(14, 'vywojizug@mailinator.com', '$2y$10$81ynZQVvXB8YKoLVV0UqaurZIKXlprOpu.O/DAcWH0gN1itAV5IEK', NULL, NULL, NULL, NULL),
	(15, 'dyzabejit@mailinator.com', '$2y$10$mtVFaZ6v0.E6ZCgJL2TjEOBhcV2CNDTr84xtMvHk7R5.pDFf9Hc3O', NULL, NULL, NULL, NULL),
	(16, 'cujahim@mailinator.com', '$2y$10$ePpKNx8t5TwDmW60tSCWEuqnBcdHTLhI6Ij2sBDtRhk3i/rqlZK8q', NULL, NULL, NULL, NULL),
	(17, NULL, NULL, NULL, NULL, NULL, 'Dahlia Boone'),
	(18, NULL, NULL, NULL, NULL, NULL, 'Lynn Stout'),
	(19, NULL, 'dsdsd', NULL, NULL, NULL, 'Chadwick Petersen'),
	(20, NULL, 'Pa$$w0rd!', NULL, NULL, NULL, 'Palmer Aguirre'),
	(21, 'zivolav@mailinator.com', 'Pa$$w0rd!', 'Galvin Valencia', NULL, NULL, 'Galvin Valencia'),
	(22, 'pulixef@mailinator.com', 'Pa$$w0rd!', 'Vielka Morrison', '+1 (214) 147-5196', 'saller', 'Vielka Morrison');
