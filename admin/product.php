...
if (isset($_POST['product_upload'])) {
    ...
    $sql = "INSERT INTO product (product_name,category,type,image1,image2,price,description) VALUES ('$product_name','$category','$type','$image1','$image2','$price','$description');";
                    ...
                    <div class="col-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Products Upload</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" method="post" action="product.php" enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <div class="card-footer">
                                        <input type="submit" name="product_upload" class="btn btn-primary"
                                            value="Submit">
                                    </div>
                            </form>
                        </div>
